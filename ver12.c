...
char* cal_multiply(char *a, char *b) {  // 곱셈
   ...
   memset(answer,'0',sizeof(char)*strlen(a)*strlen(b));
   memset(temp,'0',sizeof(char)*strlen(a)*strlen(b));
   memset(temp2,'0',sizeof(char)*strlen(a)*strlen(b));
   memset(temp3,'0',sizeof(char)*strlen(a)*strlen(b));
   memset(temp4,'0',sizeof(char)*strlen(a)*strlen(b));
   memset(negative,'0',sizeof(char)*strlen(a)*strlen(b));
...
char* mul_add(char *a, char *b){
  ...
  if(strlen(a)>strlen(b)){
    ...
    int lenB = strlen(b);
    char *temp = malloc(sizeof(char)*lenA*lenB);
    memset(temp,'0',sizeof(char)*lenA*lenB);
    temp[len] = '\0';
    len--;
...
char* add_dot(char *str,int dot){
    ...
    memset(answer,'0',sizeof(char)*len2);
    memset(temp,'0',sizeof(char)*len2);
    strcpy(answer,str);
...
char* remove_zero(char* str){
  int count = 0,dotlen = 0,dotcnt = 0,i = 0,nflag = 0;
  int len = strlen(str);
  char *negative = malloc(sizeof(char)*len*2);
  char *temp = malloc(sizeof(char)*len*2);
  char *temp2 = malloc(sizeof(char)*len*2);
  char *result = malloc(sizeof(char)*len*2);
  memset(temp,'0',sizeof(char)*len*2);
  memset(temp2,'0',sizeof(char)*len*2);
  memset(result,'0',sizeof(char)*len*2);
  memset(negative,'0',sizeof(char)*len*2);
